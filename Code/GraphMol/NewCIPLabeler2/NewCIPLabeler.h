...
/**
 * Exception thrown when maximum iterations exceeded during CIP label
 * calculation. Very symmetrical molecules can cause excessive processing (e.g.
 * dodecahedrane).
 */
class RDKIT_NEWCIPLABELER2_EXPORT MaxIterationsExceeded
 ...
 */
RDKIT_NEWCIPLABELER2_EXPORT void assignCIPLabels(
